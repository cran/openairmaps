...
test_that("annulus map works in a simple way", {
  expect_no_error(annulusMap(polar_data, "nox"))
})
...
test_that("static annulus map works in a simple way", {
  expect_no_error(annulusMapStatic(polar_data, "nox"))
})
